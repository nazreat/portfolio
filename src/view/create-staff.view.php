        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <form id="formAccountSettings" method="POST" action="<?php echo $path->pageURL; ?>/dashboard-framework-v1/src/controller/create-staff.controller.php" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <select name="suburb" id="suburb" class="select2 form-select" required>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <select name="state" id="state" class="select2 form-select" required>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" name="registration_date" type="date" value="" id="date" />
                          </div>
                          <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                              <input
                                ...
                                required
                              />
                              <span class="input-group-text cursor-pointer"><i onclick="togglePasswordVisibility()" id="password_icon" class="bx bx-hide"></i></span>
                            </div>
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                              <input
                                ...
                                required
                              />
                              <span class="input-group-text cursor-pointer"><i onclick="toggleConfirmPasswordVisibility()" id="confirm_password_icon" class="bx bx-hide"></i></span>
                            </div>
                          </div>
                        </div>
                        <div class="mt-2">
                          ...
                          <button onclick="fillPasswordField()" type="button" class="btn btn-outline-info me-2">
                            Strong Password
                          </button>
...
<script>
    function togglePasswordVisibility() {
        ...
        const visibilityIcon = document.getElementById("password_icon");
        
        if (passwordField.type === "password") {
            passwordField.type = "text";
            visibilityIcon.className = "bx bx-show";
        } else {
            passwordField.type = "password";
            visibilityIcon.className = "bx bx-hide";
        }
    }
    ...
    function toggleConfirmPasswordVisibility() {
        ...
        const visibilityIcon = document.getElementById("confirm_password_icon");
    ...
    function fillPasswordField() {
        ...
        const visibilityIcon = document.getElementById("password_icon");
        visibilityIcon.className = "bx bx-show";
        const generatedPassword = generateStrongPassword(12); // generate 12 symbols passwords
