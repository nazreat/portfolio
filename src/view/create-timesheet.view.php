              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" action="<?php echo $path->pageURL; ?>/dashboard-framework-v1/src/controller/create-timesheet.controller.php">
                        <div class="row">
                          <div class="mb-3 col-md-6">
                            <label for="date" class="form-label">Date</label>
                            <input class="form-control" name="timesheet_date" type="date" value="" id="date" />
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="date" class="form-label">Start Time</label>
                            <input class="form-control" type="time" name="start_time" value="" id="html5-time-input">
                          </div>
                          <div class="mb-3 col-md-6">
