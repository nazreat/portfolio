<?php
  ...
  if (!$set_session->check_permission(['view volunteer dashboard'])) {
  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <!-- Sidebar -->
        <?php
          $sidebar = new Sidebar("dashboard-volunteers", $set_session);
                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          ...
                          <p class="mb-4">
                          <?php
                          $events = $D->getMonthlyJoinedEvents($userInfo['id']);
                          $rate = $D->getMonthlyApprovedRequests($userInfo['id']);
                          ?>
                            You have handle <span class="fw-bold"><?php echo $rate ;?>%</span> request 
                            and joined <span class="fw-bold"><?php echo $events->num_rows ;?> </span> events this month.
                          </p>
                          </p>
                          <span class="demo-inline-spacing">
                            ...
                            ?>
                                <a href="timesheets.view.php" class="btn btn-sm btn-outline-primary"><i class="tf-icons bx bx-time-five"></i>&nbsp View Timesheets</a>
                            <?php
                              }
                            ?>
                                ...
                                <div class="col-sm-9 text-sm-left">
                                  <div class="card-body">
                                    ...
                                    <p class="mb-4" style="color: black;">
                                      ...
                                      <br>
                                      <small class="text-muted">David Hui</small>
                                    </p>
...
<!-- 
                                ...
                                <div class="col-sm-9 text-sm-left">
                                  <div class="card-body">
                                    ...
                                    <p class="mb-4" style="color: black;">
                                      ...
                                      <br>
                                      <small class="text-muted">Sam Tong</small>
                                    </p>
                ...
                <div class="col-lg-6 mb-4 order-0">
                  ...
                  <div class="card h-100">
                    <h5 class="card-header">Pending timesheets</h5>
                    <hr class="my-0" />
                        ...
                        <a href="timesheets.view.php">
                          <div class="card">
                            <div class="d-flex align-items-end row">
                              ...
                              <div class="col-sm-8 text-sm-left">
                                <div class="card-body" style="padding-bottom: 8%;">
                                  <h5 class="card-title">Training (1 hours)</h5>
                                  <p class="mb-4" style="color: black;">
                                    Provide training to volunteers
                                    <br>
                                    <small class="text-muted">5 June</small>
                                    <br>
                                  </p>
                        ...
                        <a href="timesheets.view.php">
                          <div class="card">
                            <div class="d-flex align-items-end row">
                              ...
                              <div class="col-sm-8 text-sm-left">
                                <div class="card-body" style="padding-bottom: 8%;">
                                  <h5 class="card-title">Gathering (2 hours)</h5>
                                  <p class="mb-4" style="color: black;">
                                    Catch up with volunteers
                                    <br>
                                    <small class="text-muted">25 June</small>
                                    <br>
                                  </p>
                                </div>
                              </div>
                    ...
                    <?php echo $D->getTimesheets();?>
                      </div>

                    <span style="padding-left: 15px;" >
                      <div class="row">
                        <div class="card-body"  style="padding-top: 0px;">
                          <a href="timesheets.view.php" class="btn btn-lg btn-outline-primary">
                            <i class="tf-icons bx bx-time-five bx-sm"></i>
                            &nbsp View Timesheets
                          </a>
                        </div>
                      </div>
                    </span>
