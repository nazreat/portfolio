  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <!-- Sidebar -->
        <?php
          $sidebar = new Sidebar("requests", $set_session);
              ...
              <div class="card">
                   ...
                   <caption class="ms-4">
                    ...
                    <tbody class="table-border-bottom-0">
                      <?php foreach ($timesheets as $key => $value): ?>
                        ...
                        <td>
                          <?php 
                              $volunteer = $U->getUserInfoFromID($value->volunteer_id);
                              
                              echo $volunteer['first_name']." ". $volunteer['last_name'] ?>
                          </td>
                          <td>
                            <?php echo $value->date ?>
                          </td>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                ...
                                <?php
                                  if ($set_session->check_permission(['approve requests'])) {
                                ?>
                                  <a class="dropdown-item"  href="requests.view.php?id=<?php echo $value->id ?>&approve=true" style="color: green;"
                                ...
                                <?php
                                  if ($set_session->check_permission(['decline requests'])) {
                                ?>
                                  <a class="dropdown-item" href="requests.view.php?id=<?php echo $value->id ?>&decline=true" style="color: red;"
                                    ><i class='bx bx-x'></i> Decline</a
                                  >
                                <?php
                                  }
                                ?>
                ...
                if (isset($_GET['id'])) {
                    ...
                    if(isset($_GET['approve'])){
                      ...
                      $updated = $T->update_timesheet($data, $conditions);

                      if($updated > 0){
                        echo '<script type="text/javascript">';
                        echo 'window.location.href = "/dashboard-framework-v1/src/view/requests.view.php";';
                        echo '</script>';
                        exit();
                      }else {
                        echo '<script type="text/javascript">';
