                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              ...
                              name="supervisor"
                              <?php 
                              $supervisor = $U->getUserInfoFromID($eventInfo['supervisor']);

                              if($eventInfo['supervisor']!=NULL && $eventInfo['supervisor']!="" )
                              echo "value= '". $supervisor['first_name']. " ".  $supervisor['last_name']  ."' ";
                              ?>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <select id="status" name="status" class="select2 form-select" readonly>
                        ...
                        ?>
                          <a href="edit-event.view.php?id=<?php echo $id; ?>">
